...
<head>
    ...
    <title>Portfolio Details - DC Tech Corporation</title>
                    ...
                    <div class="col-lg-8">
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                @foreach ($detailVideo as $video)
                                    <div class="swiper-slide">
                                        <img src="{{ asset('storage/' . $portfolio->image) }}" alt="">
                                        <a href="{{ $video->file }}" class="glightbox play-btn mb-4"
                                            style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);background:rgba(0,0,0,0.5);border-radius:50%;padding:20px;color:white;font-size:30px;">
                                            ▶
                                        </a>
                                        {{-- <a href="{{ $video->file }}" class="glightbox play-btn mb-4"></a> --}}
                                    </div>
                                @endforeach
                        ...
                        <div class="portfolio-info">
                            ...
                            <ul>
                                ...
                                <li><strong>Project URL</strong>: <a
                                        href="{{ $portfolio->project_url }}">{{ $portfolio->project_url }}</a>
                                </li>
                            </ul>
                        </div>
                        <div class="portfolio-description">
                            <h2>{{ $portfolio->detail_title }}</h2>
                            <p>
